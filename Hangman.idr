...
main : IO ()
main = do 
          let initialWord = "Test"
          result <- game {guesses=2}
                         (MkWordState initialWord 
                                      (fromList $ nub $ unpack $ toUpper initialWord))
          case result of
            Lost (MkWordState word missing) => putStrLn ("You lose. The word was "
                                                          ++ word)
            Won game => putStrLn ("You win! The word was:" ++ initialWord)
